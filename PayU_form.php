    ...
    <form action="<?php echo $action; ?>" method="post" name="payuForm">
      ...
      <table>
        ...
        <tr>
          ...
          <td colspan="3"><textarea name="productinfo" style="width: 100%;"><?php echo (empty($posted['productinfo'])) ? '' : $posted['productinfo'] ?></textarea></td>
        </tr>
        <tr class="hd">
          <td>Success URL <span class="mand">*</span>: </td>
          <td colspan="3"><input type="text" name="surl" value="<?php echo (empty($posted['surl'])) ? $currentDir.'PayU_success.php' : $posted['surl'] ?>" size="64" /></td>
        </tr>
        <tr class="hd">
          <td>Failure URL <span class="mand">*</span>: </td>
          <td colspan="3"><input type="text" name="furl" value="<?php echo (empty($posted['furl'])) ? $currentDir.'PayU_failure.php' : $posted['furl'] ?>" size="64" /></td>
        </tr>
